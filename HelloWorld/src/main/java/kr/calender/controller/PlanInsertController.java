...
public class PlanInsertController implements Controller {
	...
	public String requestProcesser(HttpServletRequest request, HttpServletResponse response)
		...
		String plan_s_date = request.getParameter("plan_s_date");
		String plan_e_date = request.getParameter("plan_e_date");
		...
		int all_day = Integer.parseInt(request.getParameter("YN"));
		String plan_s_time = request.getParameter("plan_s_time");
		String plan_e_time = request.getParameter("plan_e_time");
